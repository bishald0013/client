  ...
  return (
    <>
          ...
          <form className="col-lg-6 jumbotron" onSubmit={handleSubmit}>
            ...
            <div className="alert_form mb-4">
              ...
              <div className="mb-3">
                ...
                <select id="alertType" name="alertType" className="form-select">
      ...
      <div className="alert alert-danger" role="alert">
        <span className="">
          Note :- Create a alert with required details and relyNrelax will
          notified you on the selected Reminder Date via SMS an Email
        </span>
      </div>
    </>
  );
